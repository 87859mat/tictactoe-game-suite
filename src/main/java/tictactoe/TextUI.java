...
public class TextUI {
    ...
    private void makeMove() {
        ...
        while(!validMove) {
            ...
            System.out.println("If you would like to load a previously saved game, enter L");
            System.out.println("If you would like to save this current game, enter S");
    ...
    private void saveGameMessage() {
        ...
        String fileName = inputScanner.nextLine();
        GameSaveLoadManager.save(tGame, fileName);
    }
